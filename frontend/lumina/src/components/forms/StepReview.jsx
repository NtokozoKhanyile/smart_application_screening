    ...
    <div className="space-y-4">
      ...
      <div className="card p-4">
        ...
        <div className="text-sm">
          <div className="mb-2"><span className="text-gray-500">Course ID: </span><span className="font-medium">{formData.course_id}</span></div>
          <div className="space-y-1">
            {formData.subjects?.map((s, i) => (
              <div key={i} className="flex justify-between">
                <span className="text-gray-500">Subject {s.subject_id}</span>
