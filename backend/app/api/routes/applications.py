...
from app.api.deps import get_current_user, require_application_owner_or_admin, require_role, require_admin
from app.db.session import get_db
from app.db.models.user import User
from app.db.models.application import Application
from app.db.models.application_subject import ApplicationSubject
from app.db.models.subject import Subject
from app.schemas.application import ApplicationCreate, ApplicationResponse as ApplicationOut, ApplicationStatusUpdate, ApplicationStatus
...
def update_application_status(
    ...
    screening = db.query(ScreeningResult).filter(ScreeningResult.application_id == application.id).first()
